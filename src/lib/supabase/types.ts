  ...
  public: {
    Tables: {
      ...
      ingresos_inventario_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "ingresos_inventario_items_ingreso_id_fkey"
            columns: ["ingreso_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "ingresos_inventario_items_producto_id_fkey"
            columns: ["producto_id"]
            isOneToOne: false
      ...
      inventario_movimientos: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "inventario_movimientos_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      sesiones_caja: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "sesiones_caja_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
